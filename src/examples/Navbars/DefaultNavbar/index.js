    ...
    <Container>
      ...
      >
        ...
        {user ? (
          ...
          <DefaultNavbarLink icon="account_circle" name= {user.displayName} route="/dashboard" light={light} />
          <SoftBox icon="account_circle" name="sign out" onClick={signOut} route="/authentication/sign-in" light={light} />
